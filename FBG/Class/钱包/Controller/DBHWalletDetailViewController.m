        ...
        [_menuView selectedBlock:^(NSInteger index) {
            if (weakSelf.neoWalletModel.isLookWallet) {
                if (!index) {
                    ...
                    // 删除钱包
                    [PPNetworkHelper DELETE:[NSString stringWithFormat:@"wallet/%ld", (NSInteger)self.neoWalletModel.listIdentifier] baseUrlType:1 parameters:nil hudString:@"删除中..." success:^(id responseObject)
                     {
