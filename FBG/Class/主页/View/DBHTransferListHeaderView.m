...
- (void)setBalance:(NSString *)balance {
    ...
    self.numberLabel.text = [NSString stringWithFormat:@"%.8lf", _balance.floatValue];
}
...
- (void)setHeadImageUrl:(NSString *)headImageUrl {
    ...
    [self.iconImageView sdsetImageWithURL:_headImageUrl placeholderImage:[UIImage imageNamed:@"卡片logo"]];
}
...
- (UILabel *)promptLabel {
    if (!_promptLabel) {
        ...
        _promptLabel.text = NSLocalizedString(@"Recently Transaction Record", nil);
