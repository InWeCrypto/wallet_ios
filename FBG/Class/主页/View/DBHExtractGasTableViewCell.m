...
- (void)setGasTokenModel:(DBHWalletDetailTokenInfomationModelData *)gasTokenModel {
    ...
    self.noExtractGasLabel.text = [NSString stringWithFormat:@"%@Gas：%.8lf", NSLocalizedString(@"No Extracted", nil), _gasTokenModel.noExtractbalance.floatValue];
    self.canExtractGasLabel.text = [NSString stringWithFormat:@"%@1.000-%.8lf", NSLocalizedString(@"Can Extracted", nil),  _gasTokenModel.canExtractbalance.floatValue];
