...
- (UIButton *)messageIconButton {
    if (!_messageIconButton) {
        ...
        [_messageIconButton setImage:[UIImage imageNamed:@"卡片logo"] forState:UIControlStateNormal];
...
- (UIButton *)showTotalBalanceButton {
    if (!_showTotalBalanceButton) {
        ...
        [_showTotalBalanceButton setImage:[UIImage imageNamed:@"闭眼1"] forState:UIControlStateNormal];
        [_showTotalBalanceButton setImage:[UIImage imageNamed:@"睁眼"] forState:UIControlStateSelected];
