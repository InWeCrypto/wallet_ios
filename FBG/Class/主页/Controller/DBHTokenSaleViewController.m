...
- (void)setUI {
    ...
    self.poundageLabel.text = [NSString stringWithFormat:@"%@：0.01 Gas", NSLocalizedString(@"Transaction Fee", nil)];
}
...
- (UILabel *)walletAddressLabel {
    if (!_walletAddressLabel) {
        ...
        _walletAddressLabel.text = [NSString stringWithFormat:@"%@:", NSLocalizedString(@"Intelligent Contract Address", nil)];
...
- (UILabel *)transferNumberLabel {
    if (!_transferNumberLabel) {
        ...
        _transferNumberLabel.text = [NSString stringWithFormat:@"NEO%@:", NSLocalizedString(@"Transfer Number", nil)];
