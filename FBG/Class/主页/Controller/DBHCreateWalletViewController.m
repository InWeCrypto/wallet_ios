...
- (void)createNewWallet {
    ...
    if (!error) {
        NSError *error;
        self.mnemonic = [self.neoWallet mnemonic:&error];
...
- (UITextField *)passwordTextField {
    if (!_passwordTextField) {
        ...
        _passwordTextField.placeholder = NSLocalizedString(@"Password Setting", nil);
    }
...
- (UITextField *)surePasswordTextField {
    if (!_surePasswordTextField) {
        ...
        _surePasswordTextField.placeholder = NSLocalizedString(@"Sure Password", nil);
    }
