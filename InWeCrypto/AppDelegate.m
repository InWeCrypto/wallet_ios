...
- (void)showThirdLogin {
    LoginFingerprintViewController *checkFaceOrTouchViewController = [[UIStoryboard storyboardWithName:LOGIN_STORYBOARD_NAME bundle:nil] instantiateViewControllerWithIdentifier:LOGIN_FINGERPRINT_STORYBOARD_VC_ID];
